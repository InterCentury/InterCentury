...
🧠 **Academics-Playground-SSC-2027** – Notes, experiments, and structured SSC prep

⚡ **TrippleE-EEE-Slops** – Basics of Electrical & Electronics for real-world projects

🐍 **Python-Playground** – Random scripts, practice, and mini experiments

🛠️ **File-Generator.py** – Simple tool to generate structured files automatically

💻 **cpp-playground** – Exploring and testing C++ concepts

🧩 **InterCentury** – Core identity repository

🏛️ **CPP-Museum** – Archive of important C++ ideas and snippets

⚙️ **BinaryFetch** – Custom system info tool (your own neofetch 👀)

🎮 **HUB-UnrealEngine** – Unreal Engine experiments and learning

📂 **InterScan-terminal-based-file-structure-previewer** – CLI tool to visualize folder structures
